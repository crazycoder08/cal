<!-- PROJECT LOGO -->
<p align="center">
  <a href="https://github.com/calcom/chykalophia.com">
    <img src="https://user-images.githubusercontent.com/8019099/133430653-24422d2a-3c8d-4052-9ad6-0580597151ee.png" alt="Logo">

  </a>

  <h3 align="center">chykalophia.com (formerly Calendso)</h3>

  <p align="center">
    The open-source Calendly alternative.
    <br />
    <a href="https://chykalophia.com"><strong>Learn more »</strong></a>
    <br />
    <br />
    <a href="https://chykalophia.com/slack">Slack</a>
    ·
    <a href="https://chykalophia.com">Website</a>
    ·
    <a href="https://github.com/calcom/chykalophia.com/issues">Issues</a>
    ·
    <a href="https://chykalophia.com/roadmap">Roadmap</a>
  </p>
</p>

<p align="center">
   <a href="https://chykalophia.com/slack"><img src="https://img.shields.io/badge/Slack-calendso.slack.com-%234A154B" alt="Join chykalophia.com Slack"></a>
   ...
   <a href="https://status.chykalophia.com"><img src="https://betteruptime.com/status-badges/v1/monitor/a9kf.svg" alt="Uptime"></a>
   <a href="https://github.com/calcom/chykalophia.com/stargazers"><img src="https://img.shields.io/github/stars/calcom/chykalophia.com" alt="Github Stars"></a>
   ...
   <a href="https://github.com/calcom/chykalophia.com/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-AGPLv3-purple" alt="License"></a>
   <a href="https://github.com/calcom/chykalophia.com/pulse"><img src="https://img.shields.io/github/commit-activity/m/calcom/chykalophia.com" alt="Commits-per-month"></a>
   <a href="https://chykalophia.com/pricing"><img src="https://img.shields.io/badge/Pricing-Free-brightgreen" alt="Pricing"></a>
   <a href="https://jitsu.com?utm_source=github/calcom/chykalophia.com"><img src="https://img.shields.io/badge/Metrics_tracked_by-JITSU-AA00FF?logo=data:image/png;base64," alt="Jitsu Tracked"></a>
   ...
   <a href="https://chykalophia.com/figma"><img src="https://img.shields.io/badge/Figma-Design%20System-blueviolet"></a>
...
That's where chykalophia.com comes in. Self-hosted or hosted by us. White-label by design. API-driven and ready to be deployed on your own domain. Full control of your events and data.
...
<a href="https://www.producthunt.com/posts/calendso?utm_source=badge-top-post-badge&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=291910&theme=light&period=monthly" alt="chykalophia.com - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/posts/calendso?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=291910&theme=light" alt="chykalophia.com - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/stories/how-this-open-source-calendly-alternative-rocketed-to-product-of-the-day" target="_blank"><img src="https://chykalophia.com/maker-grant.svg" alt="chykalophia.com - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>
...
1. Clone the repo into a public GitHub repository (or fork https://github.com/calcom/chykalophia.com/fork). If you plan to distribute the code, keep the source code public to comply with [AGPLv3](https://github.com/calcom/chykalophia.com/blob/main/LICENSE). To clone in a private repository, [acquire a commercial license](https://chykalophia.com/sales))

   ```sh
   git clone https://github.com/calcom/chykalophia.com.git
   ```
...
1. Configure environment variables in the `.env` file. Replace `<user>`, `<pass>`, `<db-host>`, `<db-port>` with their applicable values
   ...
   7. In `Settings`, copy your URI to your chykalophia.com .env file and replace the `postgresql://<user>:<pass>@<db-host>:<db-port>` with it.
...
chykalophia.com, Inc. does not provide official support for Docker, but we will accept fixes and documentation. Use at your own risk.

### Heroku

<a href="https://heroku.com/deploy?template=https://github.com/calcom/chykalophia.com">
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fcalcom%2Fchykalophia.com&env=DATABASE_URL,NEXT_PUBLIC_WEBAPP_URL,NEXTAUTH_URL,NEXTAUTH_SECRET,CRON_API_KEY,CALENDSO_ENCRYPTION_KEY&envDescription=See%20all%20available%20env%20vars&envLink=https%3A%2F%2Fgithub.com%2Fcalcom%2Fchykalophia.com%2Fblob%2Fmain%2F.env.example&project-name=cal&repo-name=chykalophia.com&build-command=cd%20../..%20%26%26%20yarn%20build&root-directory=apps%2Fweb%2F)

<!-- ROADMAP -->

## Roadmap

<a href="https://chykalophia.com/roadmap"><img src="https://user-images.githubusercontent.com/8019099/176388295-25081ca4-207e-4468-8079-37b195fa8e59.png" alt="chykalophia.com Roadmap" /></a>

See the [roadmap project](https://chykalophia.com/roadmap) for a list of proposed features (and known issues). You can change the view to see planned tagged releases.
...
9. Under Authorized redirect URI's, select Add URI and then add the URI `<chykalophia.com URL>/api/integrations/googlecalendar/callback` and `<chykalophia.com URL>/api/auth/callback/google` replacing chykalophia.com URL with the URI at which your application runs.
10. The key will be created and you will be redirected back to the Credentials page. Select the newly generated client ID under OAuth 2.0 Client IDs.
11. Select Download JSON. Copy the contents of this file and paste the entire JSON string in the .env file as the value for GOOGLE_API_CREDENTIALS key.

#### _Adding google calendar to chykalophia.com App Store_
...
1. Add extra redirect URL `<chykalophia.com URL>/api/auth/callback/google`
...
4. Set the **Web** redirect URI to `<chykalophia.com URL>/api/integrations/office365calendar/callback` replacing chykalophia.com URL with the URI at which your application runs.
...
9. Set the Redirect URL for OAuth `<chykalophia.com URL>/api/integrations/zoomvideo/callback` replacing chykalophia.com URL with the URI at which your application runs.
...
12. Click "Done".
13. You're good to go. Now you can easily add your Zoom integration in the chykalophia.com settings.
...
7. Set the Redirect URL for OAuth `<chykalophia.com URL>/api/integrations/hubspot/callback` replacing chykalophia.com URL with the URI at which your application runs.
...
10. You're good to go. Now you can see any booking in chykalophia.com created as a meeting in HubSpot for your contacts.
...
Special thanks to these amazing projects which help power chykalophia.com:

[<img src="https://chykalophia.com/powered-by-vercel.svg">](https://vercel.com/?utm_source=calend-so&utm_campaign=oss)
...
<a href="https://jitsu.com/?utm_source=chykalophia.com-gihub"><img height="40px" src="https://jitsu.com/img/powered-by-jitsu.png?gh=true" alt="Jitsu.com"></a>

chykalophia.com is an [open startup](https://chykalophia.com/open) and [Jitsu](https://github.com/jitsucom/jitsu) (an open-source Segment alternative) helps us to track most of the usage metrics.
